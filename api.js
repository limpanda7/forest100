...
router.post("/saveReservation", (req, res) => {
  ...
  connection.query(
    "INSERT INTO forest_reservation (date, name, phone, person, baby, dog, bedding, guest_room, barbecue, price, price_option, receipt, receipt_num, revisit) VALUES ?",
    [values],
    (err, data) => {
      res.send(data);
...
${revisit === "Y" ? "재방문입니다\n" : ""}`
  ...
  connection.query(
    "INSERT INTO forest_reservation_new (type, checkin_date, checkout_date, name, phone, person, baby, dog, bedding, guest_room, barbecue, price, price_option, receipt, receipt_num, revisit) VALUES ?",
    [adminValues],
    () => {}
  );
});
router.post("/updateDb", (req, res) => {
  ...
  if (action === "open") {
    connection.query(
      "DELETE FROM forest_reservation WHERE date = ?",
      picked,
      (err, data) => {
        res.send(data);
      }
  ...
  if (action === "close") {
    connection.query(
      "INSERT INTO forest_reservation (date) VALUES (?)",
      picked,
      (err, data) => {
        res.send(data);
      }
...
router.get("/getReserved2", (req, res) => {
  ...
  //   const response = data.map(({ checkin_date, checkout_date }) => {
...
router.post("/saveReservation2", (req, res) => {
  ...
  connection.query(
    "INSERT INTO onoff_reservation (date, name, phone, person, baby, dog, bedding, barbecue, student_event, price, price_option, receipt, revisit, whole_use) VALUES ?",
    [values],
    (err, data) => {
      res.send(data);
...
${revisit === "Y" ? "재방문입니다\n" : ""}`
  ...
  connection.query(
    "INSERT INTO on_off_reservation (type, checkin_date, checkout_date, name, phone, person, baby, dog, bedding, barbecue, student_event, price, price_option, revisit, whole_use) VALUES ?",
    [adminValues],
    () => {}
  );
});
router.post("/updateDb2", (req, res) => {
  ...
  if (action === "open") {
    connection.query(
      "DELETE FROM onoff_reservation WHERE date = ?",
      picked,
      (err, data) => {
        res.send(data);
      }
  ...
  if (action === "close") {
    connection.query(
      "INSERT INTO onoff_reservation (date) VALUES (?)",
      picked,
      (err, data) => {
        res.send(data);
      }
...
router.get("/reservation/on_off", (req, res) => {
  connection.query(
    "SELECT checkin_date, checkout_date FROM on_off_reservation_new where checkout_date >= NOW() order by checkin_date",
    (err, data) => {
      res.send(data);
    }
  );
...
router.post("/saveReservation3", (req, res) => {
  ...
  connection.query(
    "INSERT INTO blon_reservation (date, name, phone, person, baby, dog, bedding, barbecue, price, price_option, receipt, revisit) VALUES ?",
    [values],
    (err, data) => {
      res.send(data);
...
router.post("/updateDb3", (req, res) => {
  ...
  if (action === "open") {
    connection.query(
      "DELETE FROM blon_reservation WHERE date = ?",
      picked,
      (err, data) => {
        res.send(data);
      }
  ...
  if (action === "close") {
    connection.query(
      "INSERT INTO blon_reservation (date) VALUES (?)",
      picked,
      (err, data) => {
        res.send(data);
      }
