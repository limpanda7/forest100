export const forestMMS = (picked, person, baby, dog, barbecue, price) => {
...
export const onOffMMS = (picked, person, baby, dog, barbecue, price) => {
  return '안녕하세요 온오프스테이 입니다 :)\n' +
    ...
    ' \n' +
    '* 주소: 강원도 동해시 무릉1길 9-2\n' +
    '* 주차: 무릉복지회관 측면 공용주차장 or 도로\n' +
    '* 숙소 앞에 전기차 충전소가 있습니다(DC콤보).\n' +
    '\n' +
    '체크인: 15시 / 체크아웃: 11시 \n' +
    '입실 방법: 건물 우측 끝 흰색문 자물쇠(번호:000) 열고 대문키로 열고 출입 (현관번호: 0211*) \n\n' +
    '\n' +
    '[온오프스테이 이용수칙] \n' +
    '\n' +
    '1. 밤 10시 이후 정숙해주세요. 조용한 시골이라 주민분들이 일찍 주무십니다.\n' +
    '* 화장실은 사용 후 반드시 소등해주세요 (화장실 불빛으로 인한 민원이 발생하기도 합니다).\n'+
    '\n' +
    '2. 저희 숙소는 반려견 동반이 가능하나 침실출입을 제한하고 있습니다. 침구에 털이 묻거나 반려견으로 인한 오염에 주의 부탁드립니다.\n' +
    '\n' +
    '3. 루프탑 안전장치가 없는 관계로 출입 삼가주시고, 특히 음주상태에서 루프탑 이용시 사고가 발생할 수 있습니다. \n' +
    '\n' +
    '4. 숙소 내의 물건을 소중히 다뤄주시고 청결한 사용을 부탁드립니다.\n' +
    '* 테이블이나 의자 위치 이동 시 제자리로 돌려놓아주세요.\n' +
    '* 물건 도난/파손시 배상금이 청구 될 수 있으며, 체크아웃은 대면으로 진행합니다. \n' +
    '\n' +
    '5. 음식물쓰레기는 봉투에 담아 묶어서 마당에 음식물처리통에 놓아주시고, 일반쓰레기와 분리수거도 각각 모아주시면 됩니다.\n' +
    '\n' +
    '6. 외출 or 퇴실시: 소등, 난방 off, 현관 문단속 부탁드립니다.\n' +
    '\n' +
    '7. 숙소의 모든 공간은 금연입니다. (담배꽁초 나오면 속상해요)\n' +
    '\n' +
    '* 최근 마을 수도공사로 인해 간혹 녹물이 나올 수 있으니, 충분히 흘려보내신 후 사용해주세요.\n' +
    '* 현재 외부화장실 온수와 조명은 작동하지 않습니다.\n' +
    '\n' +
    '[바베큐 이용수칙]\n' +
